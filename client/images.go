...
*/
func BuildImages(c *docker.Client,opts docker.BuildImageOptions) error {
...
*/
func TagImages(c *docker.Client,name string,opts docker.TagImageOptions) error {
    return c.TagImage(name,opts)
}
